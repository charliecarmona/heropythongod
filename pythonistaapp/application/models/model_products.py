...
def insert_products(product,stock,description,purchase_price,price_sale,product_image):
    try:
...
def edit_products(id_product,product,stock,description,purchase_price,price_sale,product_image):
    try:
